"""Example 03: Strike surface optimisation with wall buffers on MAST-U.

This example builds on Example 02 by enabling wall buffers. When buffers are
active, the optimiser penalises field line trajectories that intersect the
buffered wall regions surrounding the divertor. This encourages the optimised
geometry to keep the scrape-off layer away from the first wall outside the
intended target plate.

The strike surface and constraints are identical to Example 02.
...
path_to_geqdsk = os.path.join(data_dir, "geqdsk", "examples", "03-mastu.geqdsk")
path_to_magnets = os.path.join(data_dir, "json", "examples", "03-mastu.json")
...
# ============================================================================
# 6. Define buffer regions
# ============================================================================

# Buffer regions are keyed by divertor region name.  Each buffer specifies a
# wall segment (R, Z endpoints) and a perpendicular distance.  Field lines that
# cross a buffer boundary incur a penalty, steering the optimiser away from
# geometries where the divertor leg grazes sensitive parts of the wall.
...
# ============================================================================
# 7. Configure and run the optimiser
# ============================================================================
